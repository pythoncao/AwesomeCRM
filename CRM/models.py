...
class CustomerInfo(models.Model):
    ...
    sex_choice = ((0,'男'),(1,'女'))
    sex = models.PositiveSmallIntegerField(choices=sex_choice,blank=True,null=True)
...
class ClassList(models.Model):
    ...
    contract_template = models.ForeignKey("ContractTemplate",blank=True,on_delete=models.CASCADE,null=True,)
